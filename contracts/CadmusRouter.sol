...
contract CadmusCustomRouter is IUniswapV2Router02 {
        ...
        returns (uint[] memory amounts)
    {
        ...
        if (msg.value > amounts[0]) TransferHelper.safeTransferETH(from, msg.value - amounts[0]);
    }
    ...
    function swapExactTokensForTokensSupportingFeeOnTransferTokens(
        ...
        TransferHelper.safeTransferFrom(
            path[0], from, UniswapV2Library.pairFor(factory, path[0], path[1]), amountIn
        );
